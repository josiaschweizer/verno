...
public class ResourceAccessTokenConfig {
  ...
  @Bean
  public ResourceAccessTokenCodec resourceAccessTokenCodec(@Value("${verno.api.resource-access-token-secret}") @Nonnull final String secret) { //TODO MOVE INTO CONFIG PROVIDER!!!
