package ch.verno.common.db.constants.instructor;

import ch.verno.common.db.constants.base.BaseEntityConstants;
import org.jetbrains.annotations.NonNls;

public class InstructorConstants extends BaseEntityConstants {

  @NonNls public static final String ENTITY_NAME = "instructor";
