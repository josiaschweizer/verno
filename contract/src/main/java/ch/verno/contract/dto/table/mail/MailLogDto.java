...
public class MailLogDto extends BaseDto<Long> {
  ...
  @Nullable private Long createdBy;
  ...
  public MailLogDto(@Nonnull final String recipientEmail,
                    ...
                    @Nullable final LocalDateTime sentAt,
                    @Nullable final LocalDateTime createdAt,
                    @Nullable final Long createdBy) {
    this(null, null, recipientEmail, recipientName, templateName, subject, content, placeholdersJson, status, errorMessage, providerMessageId, sentAt, createdAt, createdBy);
  }

  public MailLogDto(@Nullable final Long id,
  ...
  @Nonnull
  public static MailLogDto empty() {
