...
public class BillingWebhookEventDto extends BaseDto<Long> {
  ...
  @Nonnull private BillingWebhookEventStatus status;

  @Nullable private OffsetDateTime processedAt;
  @Nullable private OffsetDateTime createdAt;

  @Nonnull private String payloadJson;

  private BillingWebhookEventDto() {
    setId(null);
  ...
  @Nonnull
  public static BillingWebhookEventDto empty() {
