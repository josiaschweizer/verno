...
public class CourseLevelDto extends BaseDto<Long> {
  ...
  @Nullable private Integer sortingOrder;

  private CourseLevelDto() {
    setId(null);
  ...
  public CourseLevelDto(@Nonnull final String code,
                        @Nonnull final String name,
                        @Nonnull final String description,
                        @Nonnull final Integer sortingOrder) {
    this(null, code, name, description, sortingOrder);
  }
  ...
  public boolean equals(@Nullable final Object o) {
    ...
    if (!(o instanceof CourseLevelDto other)){
      return false;
    }
