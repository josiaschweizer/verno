...
WHERE NOT EXISTS (
    SELECT 1 FROM course_schedule_week csw
...
SELECT CURRENT_TIMESTAMP,
       ...
       (SELECT id FROM address WHERE street='Musterstrasse' AND house_number='1' AND zip_code='8000' AND city='Zürich' AND country='Schweiz' ORDER BY id DESC LIMIT 1)
...
SELECT CURRENT_TIMESTAMP,
       ...
       (SELECT id FROM address WHERE street='Bahnhofstrasse' AND house_number='10' AND zip_code='9000' AND city='St. Gallen' AND country='Schweiz' ORDER BY id DESC LIMIT 1)
...
SELECT CURRENT_TIMESTAMP,
       ...
       '+41791230002',
       (SELECT id FROM gender WHERE name = 'Male' ORDER BY id DESC LIMIT 1),
       (SELECT id FROM address WHERE street='Seestrasse' AND house_number='5' AND zip_code='6003' AND city='Luzern' AND country='Schweiz' ORDER BY id DESC LIMIT 1)
...
SELECT (SELECT id FROM course WHERE title = 'Grundkurs' ORDER BY id DESC LIMIT 1),
       (SELECT id FROM course_level WHERE code='A1' ORDER BY id DESC LIMIT 1), 0
ON CONFLICT DO NOTHING;

INSERT INTO course_course_level (course_id, course_level_id, sort_index)
SELECT (SELECT id FROM course WHERE title = 'Frühlingskurs' ORDER BY id DESC LIMIT 1),
       (SELECT id FROM course_level WHERE code='A2' ORDER BY id DESC LIMIT 1), 0
ON CONFLICT DO NOTHING;

INSERT INTO course_course_level (course_id, course_level_id, sort_index)
SELECT (SELECT id FROM course WHERE title = 'Sommerkurs' ORDER BY id DESC LIMIT 1),
       (SELECT id FROM course_level WHERE code='B1' ORDER BY id DESC LIMIT 1), 0
ON CONFLICT DO NOTHING;
...
SELECT CURRENT_TIMESTAMP,
       ...
       (SELECT id FROM address WHERE street='Musterstrasse' AND house_number='1' AND zip_code='8000' AND city='Zürich' AND country='Schweiz' ORDER BY id DESC LIMIT 1),
       'max.muster@example.com','+41791111111',
...
SELECT CURRENT_TIMESTAMP,
       ...
       (SELECT id FROM address WHERE street='Bahnhofstrasse' AND house_number='10' AND zip_code='9000' AND city='St. Gallen' AND country='Schweiz' ORDER BY id DESC LIMIT 1),
       'lea.frei@example.com','+41792222222',
...
SELECT CURRENT_TIMESTAMP,
       ...
       (SELECT id FROM address WHERE street='Seestrasse' AND house_number='5' AND zip_code='6003' AND city='Luzern' AND country='Schweiz' ORDER BY id DESC LIMIT 1),
       'noah.kunz@example.com','+41793333333',
       (SELECT id FROM parent WHERE email='peter.schmidt@example.com' ORDER BY id DESC LIMIT 1),
       (SELECT id FROM parent WHERE email='andrina.schmidt@example.com' ORDER BY id DESC LIMIT 1)
...
SELECT 8,
       12,
       false WHERE NOT EXISTS (SELECT 1 FROM mandant_settings);