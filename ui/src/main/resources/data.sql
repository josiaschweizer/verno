...
VALUES (CURRENT_TIMESTAMP, 'Ganzes Jahr', ARRAY['KW01-2026', 'KW02-2026', 'KW03-2026', 'KW04-2026']),
       (CURRENT_TIMESTAMP, 'Frühling Block', ARRAY['KW10-2026', 'KW11-2026', 'KW12-2026', 'KW13-2026']),
       (CURRENT_TIMESTAMP, 'Sommer Block', ARRAY['KW26-2026', 'KW27-2026', 'KW28-2026', 'KW29-2026']);
...
INSERT INTO course (created_at, title, capacity, location, course_level_id, course_schedule_id, duration, instructor_id)
VALUES (CURRENT_TIMESTAMP, 'Grundkurs', 20, 'Schulzimmer 1', 1, 1, 60, 1),
       (CURRENT_TIMESTAMP, 'Frühlingskurs', 12, 'Schulzimmer 2', 2, 2, 75, 2),
       (CURRENT_TIMESTAMP, 'Sommerkurs', 16, 'Turnhalle', 3, 3, 90, 3);
...
VALUES (CURRENT_TIMESTAMP, 'Max', 'Muster', DATE '2010-05-12', 1, 1, 1, 1, 'max.muster@example.com', '+41791111111', 1,
       ...
       (CURRENT_TIMESTAMP, 'Noah', 'Kunz', DATE '2009-11-20', 1, 3, 3, 3, 'noah.kunz@example.com', '+41793333333', 1,
        2);